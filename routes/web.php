...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware('can:topup wallet')->group(function () {
        ...
        Route::get('/dashboard/wallet/topup/store', [DashboardController::class, 'topup_wallet_store'])->name('dashboard.wallet.topup.store');
    });
    ...
    Route::middleware('can:apply job')->group(function () {
        ...
        Route::get('/dashboard/propsal_details/{project}/{projectApplicant}', [DashboardController::class, 'proposal_details'])->name('dashboard.proposal_details');
    });
